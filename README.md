...
6. If you did everything correct, https://ben-foster-cko.github.io/docs-demo/ will lead to your new docs
...
- Documentation(ReDoc): https://ben-foster-cko.github.io/docs-demo/
- SwaggerUI: https://ben-foster-cko.github.io/docs-demo/swagger-ui/
- Look full spec:
    + JSON https://ben-foster-cko.github.io/docs-demo/swagger.json
    + YAML https://ben-foster-cko.github.io/docs-demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://ben-foster-cko.github.io/docs-demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ben-foster-cko.github.io/docs-demo/ with url from the message: `Server started <url>`
