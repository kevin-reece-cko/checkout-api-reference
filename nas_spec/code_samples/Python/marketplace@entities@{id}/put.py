...
from checkout_sdk.marketplace.marketplace import Identification, DateOfBirth, Individual, OnboardEntityRequest, \\
...
try:
    response = api.marketplace.update_entity(request, 'entity_id')
