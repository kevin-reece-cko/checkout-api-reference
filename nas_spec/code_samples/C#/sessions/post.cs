...
SessionRequest request = new SessionRequest
{
    Source =
        new SessionCardSource
        {
            ...
            HomePhone = new Phone {Number = "4155552671", CountryCode = "1"},
            MobilePhone = new Phone {Number = "4155552671", CountryCode = "1"},
            WorkPhone = new Phone {Number = "4155552671", CountryCode = "1"}
        },
    Amount = 10,
